    ...
    with open(template_file, 'r') as template:
        ...
        parameters = [
            ...
            },
            {
                ...
                'ParameterValue': 'israel-ibrahim-ideahub-key',
            },
            {
                'ParameterKey': 'ImageId',
                'ParameterValue': 'ami-0f58b397bc5c1f2e8',
            },
            {
                'ParameterKey': 'SecurityGroup',
                'ParameterValue': 'sg-0624de30bede989d6',
            }
        ]
...
if __name__ == "__main__":
    ...
    template_file = os.path.join(script_dir, '../templates/ec2-instance.yml')

    stack_name = "ideahub-ec2-stack"
